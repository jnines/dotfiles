...
ALP_PKGS="git stow ncurses shadow yazi zsh zsh-autosuggestions zsh-syntax-highlighting zsh-vcs jq fd ripgrep fzf zoxide neovim plocate tree-sitter-cli"
ARCH_PKGS="git stow zsh zsh-autosuggestions zsh-syntax-highlighting eza bat jq fd ripgrep fzf zoxide python-pynvim neovim which npm unzip plocate tree-sitter-cli"
DEB_PKGS="git stow zsh zsh-autosuggestions zsh-syntax-highlighting eza bat npm python3-venv ffmpeg 7zip jq unzip curl fuse poppler-utils fd-find ripgrep fzf zoxide imagemagick python3-pynvim plocate tree-sitter-cli"
DEB_LITE_PKGS="git stow zsh zsh-autosuggestions zsh-syntax-highlighting jq fd-find ripgrep fzf zoxide unzip curl fuse plocate tree-sitter-cli"
